...
<div id="wrap" class="sub_wrap">
	...
	<div id="container">
		<div class="contents join_area">
			<!-- 비밀번호 재확인 -->
			<h2><spring:message code='my_page.password.001' /></h2>
				...
				<div class="section">
					<div class="table_area">
						<table class="rowtable write_table">
							...
							<tr>
							<!--message : 비밀번호  -->
								<th><label class="title" for="userPw"><em>*</em> <spring:message code='my_page.password.002' /></label></th>
								<td>
					...
					<!--message : 확인  -->
						<a href="#" id="submitBtn" class="btn btnL btn_red"><spring:message code='my_page.password.003' /></a>

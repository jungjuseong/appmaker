	...
	$('#registBtn').click(function(){
		...
		$.ajax({
			...
			success:function(result){
				switch(result){
					case 0 : 
						alert("<spring:message code='my_page.license.002' />");
						break;
					case 1 : 
						$('#licenseForm').submit();
						break;
					case 2 : 
						alert("<spring:message code='my_page.license.003' />");
						break;
					case 3 : 
						alert("<spring:message code='my_page.license.004' />");
						break;
					case 4 : 
						alert("<spring:message code='my_page.license.005' />");
						break;
				}
			}
		});
...
<div id="wrap" class="sub_wrap">
	...
	<div id="container">
		<div class="contents join_area">
			...
			<!-- 라이센스 등록 -->
			<h2><spring:message code='my_page.license.001' /></h2>
			<form action="/my/licenseRegist.html" method="post" id="licenseForm" name="licenseForm">
				...
				<div class="section">
					<div class="table_area">
						<table class="rowtable1 write_table">
							<colgroup>
								<col style="">
							</colgroup>
							<tr>
					...
					<div class="btn_area_bottom tCenter">
						<c:choose>
							<c:when test="${licenseSeq eq null }">
								<a href="#" id="registBtn" class="btn btnL btn_red"><spring:message code='my_page.license.001' /></a>
							</c:when>
							<c:otherwise>
								<a href="#" id="registBtn" class="btn btnL btn_red"><spring:message code='my_page.license.010' /></a>

...
function deleteLicenseUseDevice(licensesubSeq){
	$.ajax({
		...
		success:function(result){
			switch(result){
				case 0 : 
					alert("<spring:message code='my_page.license.device.008' />");
					break;
				case 1 : 
	...
	<div id="container">
		<form id="licenseForm" name="licenseForm" method="post" action="/my/license.html" >
			...
			<div class="my_license_device list_area">			
				...
				<!-- //man header -->
				<h2> <spring:message code='my_page.license.006' /></h2>
					
				<div class="section fisrt_section">
					<div class="paging_license">
						<div class="form_area fRight">
							<a class="btn btnL btn_red" href="/my/licenseRenew.html"><spring:message code='my_page.license.010' /></a>
						</div>
					</div>
					...
					<div class="table_area">
						<table class="col_table">
							...
							<tr>
								...
								<th scope="col"><spring:message code='my_page.license.007' /></th>
								<th scope="col"><spring:message code='my_page.license.008' /> / Total Copy</th>
							</tr>
							<tr>
							</tr>
							<c:choose>
										...
										<tr>
											...
											<td>
												<c:choose>
													...
													<c:otherwise>${licenseList.list[i].remainDt}<spring:message code='my_page.license.009' /></c:otherwise>
												</c:choose>
											</td>
											<td>
					...
					<div class="paging_license_bottom">
						<div class="form_area fRight">
							<input type="text" id="searchValue" name="searchValue" value="${searchValue }" placeholder="<spring:message code='my_page.license.device.009' />">
				...
				<div class="section section_license">
					<div class="table_area">
						<table class="col_table">
							...
							<tr>
								<th scope="col"><spring:message code='my_page.license.device.009' /></th>
								<th scope="col"><spring:message code='my_page.license.device.004' /></th>
								<th scope="col">OS</th>
								<th scope="col"><spring:message code='my_page.license.device.005' /></th>
								<th scope="col"></th>
							</tr>
							<c:choose>
								<c:when test="${empty licenseUseDevice.list}">
								<tr>
									<td align="center" colspan="5" ><spring:message code='my_page.license.device.006' /></td>
								</tr>
								</c:when>
								<c:otherwise>
									<c:forEach var="i" begin="0" end="${licenseUseDevice.list.size()-1}">
										<tr>
											...
											<td>
												<a href="" id="disabled" onclick="deleteLicenseUseDevice('${licenseUseDevice.list[i].licensesubSeq}')" class="btn btnXXS"><spring:message code='my_page.license.device.007' /></a>
											</td>
										</tr>
									</c:forEach>
								</c:otherwise>

...
// 	$("[name = couponNum]").attr('disabled', true);
	...
	if("${content.nonmemDownGb}" =="2"){
		...
		$("#c_start_date").val(starDt);
		$("#c_end_date").val(endDt);
	}
	...
	if("${content.memDownGb}" == "3"&&!("${content.distrGb}" =="2" && "${content.couponGb}" == "1")){
		...
		$("#d_start_date").attr("readonly", true);
		$("#d_end_date").attr("readonly", true);
		$("#d_start_date").attr("disabled", true);
		$("#d_end_date").attr("disabled", true);
		$("#d_start_date").val("");
		$("#d_end_date").val("");
	}
	...
	if("${content.distrGb}" =="2" && "${content.couponGb}" == "1"){
		...
		if("${content.nonmemDownGb}" =="1"){
			$("#c_start_date").attr("readonly", true);
	...
	if("${content.memDownGb}" == "2"){
		...
		$("#d_start_date").val(starDt);
		$("#d_end_date").val(endDt);
	} 
	...
	if("${content.couponGb}" == "2"){
		...
		$("#c_start_date").attr("readonly", true);
		$("#c_end_date").attr("readonly", true);
		$("#c_start_date").attr("disabled", true);
		$("#c_end_date").attr("disabled", true);
		$("#c_start_date").val("");''
		$("#c_end_date").val("");
	}
							...
							<td colspan="3">
								<div class="radio_area coupon_area" style="width:100%">
									...
									<span>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="d_start_date" name="memDownStartDt" type="text" title="" value="${memDownStartDt }" class="date fmDate1" value="" />
										&nbsp;&nbsp;~&nbsp;&nbsp;
										<input id="d_end_date" name="memDownEndDt" type="text" title="" value="${content.memDownEndDt }"  class="date toDate1" value="" />
									</span>
									<br>
									<span>
								...
								<div class="radio_area coupon_area">
									...
									<span style="width:100%;">
										...
										<span style ="width:100%;">
											...
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="c_start_date" name="nonmemDownStarDt" type="text" title="" value="${nonmemDownStarDt }" class="date fmDate2 startDate" value="" />
											&nbsp;&nbsp;~&nbsp;&nbsp;
											<input id="c_end_date" name="nonmemDownEndDt" type="text" title=""  value="${nonmemDownEndDt  }"  class="date toDate2 endDate" value="" />
										</span>
										<br>
										<span style="width:100%;">
											<c:choose>

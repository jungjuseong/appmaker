		...
		if($("#idValidFlag").val() == "0"){
			...
			if(!$(".error").text().length && $("#preventSubmit").val() == 0){
				if($("#email").val().length){
					...
					$("#preventSubmit").val("1");
				}else if(!($("#dateCheckGb").is(":checked")) || ($("#dateCheckGb").is(":checked") && $("#d_start_date").val().length && $("#d_end_date").val().length)){
 ...
 --%>						
						<tr id="useDate">
							...
							<td colspan="3">
								...
								<input id="d_start_date" style="padding-left:5px;" name="userStartDt" readonly="readonly" disabled="disabled"type="text" title="start date" class="date fmDate1" value="<fmt:formatDate value="${memberVO.userStartDt}" pattern="yyyy-MM-dd"/>" />
										&nbsp;&nbsp;~&nbsp;&nbsp;
								<input id="d_end_date" name="userEndDt" type="text" title="end date" readonly="readonly" disabled="disabled" class="date toDate1" value="<fmt:formatDate value="${memberVO.userEndDt}" pattern="yyyy-MM-dd"/>" />
							</td>
						</tr>
					</table>
				</div>
				...
				<div class="btn_area_bottom tCenter">
					...
					<input type="hidden" name="userGb" id="userGb" value="63"/>

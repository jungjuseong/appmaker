					...
					<div class="table_area">
						<table class="rowtable write_table">
							...
							<tr id = "useDate">
								...
								<td colspan="3">
									<input id="d_start_date" style="padding-left:5px;" name="noticeStartDt" type="text" title="start date" class="date fmDate1" value="<fmt:formatDate value="${noticeVO.noticeStartDt}" pattern="yyyy-MM-dd"/>" />
											&nbsp;&nbsp;~&nbsp;&nbsp;
									<input id="d_end_date" name="noticeEndDt" type="text" title="end date" class="date toDate1" value="<fmt:formatDate value="${noticeVO.noticeEndDt}" pattern="yyyy-MM-dd"/>" />
								</td>
							</tr>
							<tr>

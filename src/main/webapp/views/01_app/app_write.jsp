...
<div id="wrap" class="sub_wrap">
	...
	<div id="container">
		...
		<form name="appForm" id="appForm" method="post" enctype="multipart/form-data" action="" >
			...
			<div class="tab_area">
				<ul>
					<li class="<c:if test="${'2' eq appVO.regGb }">current</c:if>"><a href="/app/regist.html?regGb=2&isAvailable=${param.isAvailable }"><spring:message code='app.write.text1' /></a></li>
					<li class="last<c:if test="${'1' eq appVO.regGb }"> current</c:if>"><a href="/app/regist.html?regGb=1&isAvailable=${param.isAvailable }"><spring:message code='app.write.text2' /></a></li>
				</ul>
			</div>
							...
							<td>
								<div class="radio_area coupon_area" style="width:100%">
									...
									<span>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="d_start_date" name="memDownStartDt" type="text" title="start date" class="date " value="" readonly/>
										&nbsp;&nbsp;~&nbsp;&nbsp;
										<input id="d_end_date" name="memDownEndDt" type="text" title="end date"   class="date " value="" readonly/>
									</span>
									<br>
									<span>
							...
							<td>
								<div class="radio_area coupon_area" style="width:100%">
									...
									<span>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="c_start_date" name="noMemDownStartDt" type="text" title="start date" class="date " value="" readonly/>
										&nbsp;&nbsp;~&nbsp;&nbsp;
										<input id="c_end_date" name="noMemDownEndDt" type="text" title="end date"   class="date " value="" readonly/>
									</span>
									<br>
									<span>

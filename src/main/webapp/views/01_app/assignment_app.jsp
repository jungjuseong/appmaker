						...
						if(data.length > 0){
							...
							$('#assignTable1').append(
									"<colgroup>"
										...
										+"<col style='width:'>"
									+"</colgroup>"
									+"<tr class='bottom_line bold' style='background-color:#F3F3F3;'>"
										+"<td><spring:message code='extend.local.064' /></td>"
										+"<td><spring:message code='extend.local.065' /></td>"
										+"<td>OS</td>"
										+"<td>TYPE</td>"
					...
					<div class="pop_section">
						<div class="clfix">
							<div class="category_detail">
								...
								<div class="scroll_it outline tCenter defaultCursor preventTextSelection">

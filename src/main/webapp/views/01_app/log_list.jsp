					...
					<div class="form_area fRight">
						<form>
							<field_set>
								...
								<input id="d_start_date" style="padding-left:5px; width:110px;" readonly="readonly" disabled="disabled" name="userStartDt" type="text" title="start date" class="date fmDate1" value="<c:if test="${ '1' eq param.dateIsCheck}">${startDate }</c:if>" />
										&nbsp;&nbsp;~&nbsp;&nbsp;
								<input id="d_end_date" style="width:110px;" name="userEndDt" type="text" title="end date" readonly="readonly" disabled="disabled"  class="date toDate1" value="<c:if test="${ '1' eq param.dateIsCheck}">${endDate }</c:if>" />
